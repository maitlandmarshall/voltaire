...
| `assets/cover.jpg` | `output/pdf/assets/voltaire_divine_dossier_plate.png` | Reused repository artwork / artistic reconstruction from the prior local dossier; quality-94 delivery re-encode |
